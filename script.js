(function () {
    ...
    function navigateToSection(targetId, fromHistory = false) {
    ...
    // URL Hash Landing (Direct Link Support)
    document.addEventListener("DOMContentLoaded", () => {
        // If URL contains #hash, go directly to that section
        if (window.location.hash) {
            navigateToSection(window.location.hash);
        }
    });

    // Expose functions used in HTML inline event handlers to the global scope
